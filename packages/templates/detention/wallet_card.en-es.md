...
**STATUS: §4 SIGNED OFF — Taylor (EOIR-registered attorney).** The §4 rights script and the DO-NOT-SIGN / voluntary-departure language are signed off (bars / VD / expedited-removal accuracy verified). The card is entirely §4 content, so the "DRAFT — for attorney review" line has been removed from the rendered card.
...
1. **§4 rights script + immigration-limits wording** — ✓ signed off by Taylor (DO-NOT-SIGN rule and voluntary-departure line included).
