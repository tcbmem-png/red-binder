---
title: Durable Financial Power of Attorney — Universal (UPOAA-based)
state: {{governing_law_state}}
generated_date: {{generated_date}}
---

# **DURABLE FINANCIAL POWER OF ATTORNEY**

## **(Universal form — built on the Uniform Power of Attorney Act)**

<!-- DRAFT — for attorney clause-level review. Not final, not legal advice. Spanish (ES) lines
are added in build phase 8 after Taylor signs off on this English text; this file is EN-only by
design until then. Every operative clause is tagged to its UPOAA source section in the VERIFIED
block below; confirm each against the official act text before this sheds the DRAFT label. -->
...
I, **{{principal_first}} {{principal_last}}**, of **{{principal_county}}** County, residing at **{{principal_address}}**, declare this to be my Durable Financial Power of Attorney.
...
I appoint the following person as my Agent (Attorney-in-Fact) to act in my name under this document:
...
If neither my Agent nor my Successor Agent can serve, I appoint:
...
The meaning and effect of this Power of Attorney, and the authority of my Agent under it, are governed by the law of the State of **{{governing_law_state}}**. *(UPOAA § 107 — meaning and effect determined by the jurisdiction indicated in the instrument.)*
...
3. involuntary confinement in a county, state, federal, or immigration facility;
4. detention by U.S. Immigration and Customs Enforcement (ICE);
...
This Power of Attorney is durable. It is **not** terminated by my subsequent disability, incapacity, detention, or removal from the United States. *(UPOAA § 104 — a power of attorney is durable unless it expressly provides that it is terminated by the principal's incapacity; this instrument provides the opposite.)*

<!-- pagebreak -->

---

# **ARTICLE IV — GRANT OF GENERAL AUTHORITY**

My Agent may act for me in all matters related to my finances and property, including but not limited to:

- Banking and credit-union transactions
- Real estate — buying, selling, leasing, refinancing
- Business operations and corporate interests
- Tax matters
- Insurance and annuities
- Retirement accounts
- Digital assets, accounts, and online services
- Personal-property transactions
- Motor-vehicle transactions
- Utility and service-account access
- Hiring attorneys and advisors
- Filing or defending legal claims on my behalf
- Accessing mail, including USPS forwarding

The intent of this Power of Attorney is that my Agent may do **anything with respect to my property and financial matters that I could do personally**. *(Tracks the UPOAA subjects of general authority, §§ 204–216, incorporated by a general grant under § 201(c).)*

---

# **ARTICLE V — REAL PROPERTY AUTHORITY**

My Agent may execute deeds, deeds of trust, mortgages, and leases; take title to, transfer, or encumber real estate; manage rental property; initiate or defend eviction actions; hire property management; and satisfy liens and pay taxes. This includes real property in any state.

---

# **ARTICLE VI — BUSINESS INTERESTS**

My Agent may operate any business I own; vote membership shares in limited-liability companies; manage corporations or partnerships; buy or sell business interests; wind down or dissolve entities; sign contracts; and negotiate leases or vendor agreements.
...
# **ARTICLE VIII — IMMIGRATION-CONTEXT AUTHORITY**

My Agent is specifically authorized to retain immigration counsel; obtain copies of my immigration file; pay bond; pay attorney fees; pay USCIS and consular filing fees; access ICE detainee accounts; communicate with immigration authorities; authorize travel arrangements; request humanitarian parole; and pay costs related to international relocation of my children or family members.
...
A person presented with this Power of Attorney should either accept it or request a certification, a translation, or an opinion of counsel no later than seven business days after it is presented, and should not require an additional or different form of power of attorney. *(UPOAA § 120.)*

I indemnify any person who in good faith accepts my Agent's instructions under this Power of Attorney.
...
**{{principal_first}} {{principal_last}}**
...
To be honored as widely as possible, this Power of Attorney is signed before **two disinterested adult witnesses**, neither of whom is my Agent. *(No state requires more than a notary plus two disinterested adult witnesses; signing to this standard clears every U.S. jurisdiction. See the execution-instructions sheet.)*

We, the undersigned witnesses, declare that the Principal signed this Power of Attorney in our presence, appeared to be of sound mind, and was not acting under duress, fraud, or undue influence.
...
**Notarization is required.** The Principal must appear before the notary as that state's law allows (in person, or by audio-video where authorized).
...
On this _____ day of ____________________, 20___, before me, the undersigned notarial officer, personally appeared **{{principal_first}} {{principal_last}}**, known to me or satisfactorily proven to be the person whose name is subscribed to the foregoing instrument, who acknowledged that he or she executed it for the purposes it contains.
...
Title of Office: _______________________________
